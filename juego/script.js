...
var mainState = {
    ...
    preload: function() {
        ...
        game.load.image('background', 'https://images2.alphacoders.com/497/497194.png')
        game.load.image('player', 'https://s21.postimg.org/jyqzb5xfr/player.png')
        game.load.image('bullet', 'https://s7.postimg.org/guhgki5l7/bullet.png');
        game.load.image('green', 'https://s18.postimg.org/isuikhb8p/saibaman.png')
        ...
        game.load.bitmapFont('spacefont', 'https://s30.postimg.org/el76eneht/font.png', 'https://rawgit.com/jschomay/phaser-demo-game/master/assets/spacefont/spacefont.xml');
        game.load.image('blue', 'https://68.media.tumblr.com/avatar_498b2194f97c_128.png')
        ...
        game.load.image('boss', 'https://s12.postimg.org/hvl0ci9d9/vegeta2.png');
        game.load.image('deathRay', 'https://s14.postimg.org/whhyj2ci9/greebullet.png');
    ...
    create: function() {
        ...
        shields.render = function() {
            shields.text = 'Armadura - KI: ' + Math.max(player.health, 0) + '%';
        };
        shields.render();
...
var bootStage = {
        preload: function() {
            ...
            game.load.image('loading-bar', 'https://martinsindustries.com/wp-content/uploads/2015/10/712.gif')
