...
var mainState = {
    ...
    preload: function() {
        ...
        game.load.image('background', 'https://raw.githubusercontent.com/Ayrton94/Phaser-Game/master/assets/img/background.png')
        game.load.image('player', 'https://raw.githubusercontent.com/Ayrton94/Phaser-Game/master/assets/img/player.png')
        game.load.image('bullet', 'https://raw.githubusercontent.com/Ayrton94/Phaser-Game/master/assets/img/bullet.png');
        game.load.image('green', 'https://raw.githubusercontent.com/Ayrton94/Phaser-Game/master/assets/img/saibaman.png')
        game.load.spritesheet('explosionAnim', 'https://raw.githubusercontent.com/Ayrton94/Phaser-Game/master/assets/img/explode.png', 128, 128)
        game.load.bitmapFont('spacefont', 'https://raw.githubusercontent.com/Ayrton94/Phaser-Game/master/assets/font/spacefont.png', 'https://raw.githubusercontent.com/Ayrton94/Phaser-Game/master/assets/font/spacefont.xml');
        game.load.image('blue', 'https://raw.githubusercontent.com/Ayrton94/Phaser-Game/master/assets/img/broly.png')
        game.load.image('blueEnemyBullet', 'https://raw.githubusercontent.com/Ayrton94/Phaser-Game/master/assets/img/brolybullet.png');
        game.load.image('boss', 'https://raw.githubusercontent.com/Ayrton94/Phaser-Game/master/assets/img/vegeta2.png');
        game.load.image('deathRay', 'https://raw.githubusercontent.com/Ayrton94/Phaser-Game/master/assets/img/bossbullet.png');
    ...
    create: function() {
        ...
        shields.render = function() {
            shields.text = 'KI: ' + Math.max(player.health, 0) + '%';
        };
        shields.render();
    ...
    update: function() {
        ...
        this.backgroundImg.tilePosition.y += 0;
...
var Menu = {
    preload: function() {
        game.load.image('background', 'https://s-media-cache-ak0.pinimg.com/736x/ba/37/99/ba3799d56404af3264ccdd5fc812b941.jpg')
        game.load.image('play-back', 'http://icons.iconarchive.com/icons/icons-land/play-stop-pause/256/Play-Normal-icon.png');

    },
    create: function() {
        this.backgroundImg = this.game.add.tileSprite(0, 0, 500, 550, 'background')

        this.gameText = game.add.text(game.world.centerX - 190, game.world.centerY - 200, "DBZ DOKKAN BATTLE ", {
            font: "35px Homer Simpson",
            fill: "#0E12F2",
            fontWeight: "bold",
            stroke: "white",
            strokeThickness: 2.5
        ...
        this.gameText.angle =
*/
        play = game.add.sprite(60, 340, 'play-back')
...
var Game_Over = {
    ...
    preload: function() {
        game.load.image('background', 'https://s-media-cache-ak0.pinimg.com/originals/6e/7e/c1/6e7ec1358e93e3e6812c1c20d749da91.jpg')
        game.load.image('play-back', 'http://pngimages.net/sites/default/files/repeat-button-png-image-48944.png');
    ...
    create: function() {
        ...
        this.backgroundImg = this.game.add.tileSprite(0, 0, 500, 550, 'background')
        this.gameText = game.add.text(game.world.centerX, game.world.centerY - 200, "Game Over", {
            font: "60px Homer Simpson",
            fill: "#0E12F2",
            fontWeight: "bold",
            stroke: "white",
            strokeThickness: 2.5
        ...
        this.scoreGameOver = game.add.text(game.world.centerX, game.world.centerY - 145 , "Puntos : " + score, {
            font: "30px Homer Simpson",
            fill: "#0E12F2",
            fontWeight: "bold",
            stroke: "white",
            strokeThickness: 2.5
        ...
        play = game.add.sprite(60, 380, 'play-back')
    ...
    update: function() {
        ...
        this.backgroundImg.tilePosition.x += 0;
    },
    render: function() {
...
var bootStage = {
        preload: function() {
            ...
            game.load.image('loading-bar', 'https://raw.githubusercontent.com/Ayrton94/Phaser-Game/master/assets/img/loading-bar.gif')


        },
        create: function() {

            this.gameText = game.add.text(game.world.centerX, game.world.centerY - 100, "Cargando", {
                font: "60px Homer Simpson",
                fill: "#0E12F2",
                fontWeight: "bold",
                stroke: "white",
